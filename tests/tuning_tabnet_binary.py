...
TRAIN_DATA_PATH = '/www/dslib/spark_sota_modeling/dataset/home-credit-default-risk/train.parquet'
CAT_FEATURES_PATH = '/www/dslib/spark_sota_modeling/dataset/home-credit-default-risk/categorical_features.txt'
FEATURES_PATH = None
TARGET_COL = 'target'
...
STUDY_NAME = 'tabnet-binary-home-credit'
STORAGE_DIR = 'tuning'
N_TRIALS = 30
...
def define_parameter_space(trial: optuna.Trial) -> dict:
    return {
        ...
        'dropout_glu': trial.suggest_float('dropout_glu', 0.0, 0.4),
